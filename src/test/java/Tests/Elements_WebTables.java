...
public class Elements_WebTables extends BaseTest {
    ...
    String webTablesBoxExpectedURL = "https://demoqa.com/webtables";
    ...
    public void pageSetUp() {
        ...
        Assert.assertEquals(driver.getCurrentUrl(), webTablesBoxExpectedURL);
    }
    ...
    public void userCanAddRecord() {
        ...
        String email = "k.malone@mail.com";
        String age = "42";
